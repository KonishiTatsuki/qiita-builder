...
let mockUpdate = jest.fn().mockReturnValue({
...
describe("deleteArticle", () => {
  it("deleteArticle should call supabase update method", async () => {
    const $config = {
      public: {
        supabase: {
    ...
    await wrapper.vm.deleteArticle(181);

    expect(mockUpdate().eq).toHaveBeenCalledWith('id', 181);
  });
});
